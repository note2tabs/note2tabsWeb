...
describe("gte tuning", () => {
  it("calculates fretted MIDI directly from the open string", () => {
    expect(fretMidi(40, 0)).toBe(40);
    expect(fretMidi(40, 12)).toBe(52);
    expect(getTabMidi({ tuning: { openStringMidi: [64, 59, 55, 50, 45, 38], capo: 2 } }, [0, 0])).toBe(66);
  });
