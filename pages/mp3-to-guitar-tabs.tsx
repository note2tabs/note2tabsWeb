...
export default function Mp3ToGuitarTabsPage() {
  return (
    <SeoLandingPage
      ...
      description="Convert an MP3 into a structured, editable guitar tab online, then play, arrange, practise, and export it with Note2Tabs."
      ...
      detail={{
        ...
        paragraphs: [
          "Upload an MP3 from your computer or phone and choose the part you want to convert. Note2Tabs creates structured tablature that opens directly as a native editor project.",
