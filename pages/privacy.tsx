    ...
    <main className="page">
      <div className="container stack" style={{ maxWidth: "820px" }}>
        ...
        <p className="page-subtitle">
          We store account data and transcription history in a local SQLite database via Prisma. Audio is
          sent to a FastAPI server for processing. Only upload content you have rights to.
        </p>
