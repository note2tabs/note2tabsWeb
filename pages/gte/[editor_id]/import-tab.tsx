...
export default function ImportAsciiTabPage({ editorId }: Props) {
  ...
  return (
    <>
      <NoIndexHead title="Import text tab | Note2Tabs" canonicalPath={`/gte/${editorId}/import-tab`} />
